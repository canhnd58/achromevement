We are using code convension of [ESLint Config for JavaScript Standard Style](https://github.com/standard/standard) with some changed rules:
- comma-dangle
- [semi](#semicolons)
...
* <a name="commadangle"></a>**Trailing commas are required when using multiple lines.**
